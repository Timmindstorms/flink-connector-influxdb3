 ...
 * - Updated package to dev.timmindstorms.flink.streaming.connectors.influxdb3.common.
 */
package dev.timmindstorms.flink.streaming.connectors.influxdb3.common;
 ...
 *
 * <p>
 * {@link InfluxParser} parses line protocol into this data point
 * representation.
 */
public final class DataPoint {
    ...
    /**
     * Converts the DataPoint object to {@link Point} object. The default precision
     * for timestamps
     * is in nanoseconds. For more information about timestamp precision please go
     * to <a
    ...
    public Point toPoint() {
        ...
        point.setTimestamp(this.timestamp, WritePrecision.NS);
     ...
     * timestamp. If you submit
     * line protocol with the same measurement, tag set, and timestamp, but with a
     * different field
     * set, the field set becomes the union of the old field set and the new field
     * set, where any
     * conflicts favor the new field set.
     *
     * @see <a
     *      href=
     *      "https://docs.influxdata.com/influxdb/cloud/reference/syntax/line-protocol/#duplicate-points">
     *      Duplicate points </a>
